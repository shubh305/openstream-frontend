 ...
 * - Hover interactions for control visibility
...
export function VideoPlayer({ posterUrl, videoUrl }: VideoPlayerProps) {
    ...
    return (
        <div 
            ref={containerRef}
            className="group relative aspect-video w-full overflow-hidden bg-black rounded-xl"
