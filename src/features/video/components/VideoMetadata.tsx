    ...
    <div className="space-y-4 py-4">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex items-center gap-3">
            ...
            <Button variant="secondary" className="ml-4 rounded-full font-medium">
                Subscribe
            </Button>
        </div>
        ...
        <div className="flex items-center gap-2">
            <div className="flex items-center rounded-full bg-neutral-100 dark:bg-neutral-800">
                <Button variant="ghost" className="rounded-l-full px-4 hover:bg-neutral-200 dark:hover:bg-neutral-700">
