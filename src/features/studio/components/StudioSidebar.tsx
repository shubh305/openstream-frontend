    ...
    <aside className="w-64 border-r border-noir-border bg-noir-terminal flex flex-col h-full shrink-0">
      ...
      <div className="p-6 border-b border-noir-border">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-noir-bg border border-noir-border flex items-center justify-center">
            <span className="text-electric-lime font-bold">P1</span>
          </div>
          <div className="flex-1 min-w-0">
            <div className="text-sm font-bold text-white truncate">Player One</div>
            <div className="text-[10px] text-muted-text font-mono uppercase tracking-widest truncate">Sub::117</div>
          </div>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive 
                  ? "bg-electric-lime/10 text-electric-lime font-medium border border-electric-lime/20" 
      ...
      <div className="p-4 border-t border-noir-border space-y-1">
        {BOTTOM_ITEMS.map((item) => (
          <Link
            key={item.href}
            href={item.href}
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-muted-text hover:text-white hover:bg-white/5 transition-colors"
          >
